...
.. |travis_stable| image:: https://travis-ci.org/kezabelle/django-template-selector.svg?branch=0.2.3
...
You can use `pip`_ to install the ``0.2.3`` version from `PyPI`_::

    pip install django-templateselector==0.2.3
